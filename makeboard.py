...
header = 'Data is taken from the Department of Italian Civil Protection for key transmission parameters of an ' \
         'institutional outbreak during the 2020 SARS-Cov2 pandemic in Italy '
