...
# URLs 
url_nazionale = 'https://raw.githubusercontent.com/pcm-dpc/COVID-19/master/dati-andamento-nazionale/dpc-covid19-ita' \
...
# variables
nzero = 6  # number of consecutives zero accepted as a sequence, breaks the sequence with a 1
...
# data frame which will have index = zone names, columns = dates, cell = number of new cases per day for each zone if
# is filled by three different functions that retrieve and elaborated data based on the area (national, regional,
# provincial)
